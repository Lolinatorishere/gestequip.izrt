...
function on_request_add_load($auth_groups , $data_request , $pdo , $user_id){
...
function on_request_add_refresh($auth_groups , $data_request , $pdo , $user_id){
...
function read_request_add($data_request , $pdo , $user_id){
    ...
    if(!isset($data_request["refresh"])){
        return on_request_add_load($auth_groups , $data_request , $pdo , $user_id);
    }else{
        return on_request_add_refresh($auth_groups , $data_request , $pdo , $user_id);
    }
}
